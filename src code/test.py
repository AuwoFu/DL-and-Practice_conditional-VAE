...
if __name__=="__main__":
    ...
    # create dataset
    train_set=bair_robot_pushing_dataset(args,mode='train')
    test_set=bair_robot_pushing_dataset(args,mode='test')
    valid_set=bair_robot_pushing_dataset(args,mode='validate')
    ...
    for i, (seq,cond) in enumerate(train_loader):
        print(seq.shape,cond.shape)
        raise Exception